$(function () {
	...
	//显示简历框
	styleBox.addClass("#work-box", "box ");
	...
	workBox.load("<li class='writecode'>主要负责系统网站的前端所有模块的开发，处理前端代码的系统性能问题和代码模块化问题，<br>提升了代码的可读性和健壮性.</li>");
	...
	workBox.load("<ul>");
	workBox.load("<div class='lr-box writecode'> <span class='lr-box-left project-title '>FE3O4</span> <span class='project-time'>2019.11 - 2020.05</span> </div>");
	workBox.load("<li class='writecode'>FE3O4是一个基于websocket的即时通讯app</li>");
	workBox.load("<li class='writecode'>主要负责实现首页，学校介绍页，校园导览页，校园美景的渲染等业务的要求。</li>");
	workBox.load("<li class='writecode'>主要负责实现登录注册页、好友页、搜索页、用户详情页、聊天页面的渲染等业务的要求。</li>");
	workBox.load("<li class='writecode'>登录注册使用正则表达式进行格式判断</li>");
	workBox.load("<li class='writecode'>搜索好友时通过防抖来减少不必要的损耗</li>");
	workBox.load("</ul>");
